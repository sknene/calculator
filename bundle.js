...
;// CONCATENATED MODULE: ./src/domain/calc.ts
...
var isTerm = function (op) { return op === "*" || op === "/"; };
var num = function (n) { return ({ minus: false, positive: n }); };
var zero = function () { return num(0); };
var toNum = function (number) {
    return number.minus ? -number.positive : number.positive;
};
var fromNum = function (num) { return ({
    minus: num < 0,
...
(function (State) {
    ...
    State["num_entered"] = "num_entered";
    State["op_entered"] = "op_entered";
    State["evaluated"] = "evaluated";
})(State || (State = {}));
var evalTerm = function (stack) {
    var top = stack.pop();
    if (top === undefined) {
        return zero();
    }
...
var evalExpr = function (stack) {
    var acc = evalTerm(stack);
    while (true) {
        var op = stack.pop();
        if (op === undefined) {
            break;
...
var evalStack = function (stack) {
    var copiedStack = stack.slice().reverse();
    return evalExpr(copiedStack);
};
var stackTop = function (stack) { return stack[stack.length - 1]; };
var stack2nd = function (stack) { return stack[stack.length - 2]; };
// Model
var CalculatorModel = /** @class */ (function () {
    ...
    CalculatorModel.prototype.num = function (n) {
        switch (this.state) {
            case State.initial:
    ...
    CalculatorModel.prototype.allClear = function () {
        this.current = zero();
        this._point = 0;
        this.input = false;
        this.stack = [];
    ...
    CalculatorModel.prototype.eq = function () {
        switch (this.state) {
            case State.initial:
                return;
            case State.evaluated:
                ...
                break;
            case State.num_entered: {
                var top_1 = stackTop(this.stack);
                if (top_1) {
                    this.thunk = { op: top_1.op, r: __assign({}, this.current) };
                }
                this.stack.push({ type: "num", n: __assign({}, this.current) });
                this.current = evalStack(this.stack);
                break;
            }
            case State.op_entered:
                this.thunk = {
                    op: stackTop(this.stack).op,
                    r: __assign({}, stack2nd(this.stack).n),
                };
                this.stack.push({ type: "num", n: __assign({}, this.current) });
                this.current = evalStack(this.stack);
                break;
    ...
    CalculatorModel.prototype.op = function (op) {
        switch (this.state) {
            case State.initial:
            case State.evaluated:
            case State.num_entered:
            ...
            case State.op_entered:
                this.stack.pop();
                if (isTerm(op)) {
                    var n = stackTop(this.stack).n;
                    this.current = __assign({}, n);
                }
                else {
                    this.current = evalStack(this.stack);
                }
    ...
    CalculatorModel.prototype.add = function () {
        this.op("+");
    };
    CalculatorModel.prototype.sub = function () {
        this.op("-");
    };
    CalculatorModel.prototype.mul = function () {
        this.op("*");
    };
    CalculatorModel.prototype.div = function () {
        this.op("/");
    };
    CalculatorModel.prototype.plusMinus = function () {
        switch (this.state) {
            case State.initial:
            case State.op_entered:
                this.current = zero();
    ...
    CalculatorModel.prototype.percent = function () {
        switch (this.state) {
            ...
            case State.evaluated:
                ...
                break;
            case State.op_entered: {
                var op = stackTop(this.stack).op;
                if (isTerm(op)) {
                    this.current.positive /= 100;
                }
                else {
                    var n = stack2nd(this.stack).n;
                    var r = __assign({}, this.current);
                    r.positive /= 100;
            ...
            case State.num_entered: {
                var top_2 = stackTop(this.stack);
                if (top_2 && top_2.type === "op" && !isTerm(top_2.op)) {
                    var tmp = this.stack.pop();
                    var val = evalStack(this.stack);
                    this.stack.push(tmp);
                    var p = __assign({}, this.current);
                    p.positive /= 100;
    ...
    CalculatorModel.prototype.point = function () {
        switch (this.state) {
            case State.initial:
            case State.op_entered:
                this.current = zero();
    ...
    CalculatorModel.prototype.getActiveOp = function () {
        switch (this.state) {
            case State.evaluated:
            case State.initial:
                return;
            case State.op_entered:
                return stackTop(this.stack).op;
            case State.num_entered:
                if (!this.input) {
                    var top_3 = stackTop(this.stack);
                    if (top_3)
                        return top_3.op;
                }
                return;
    ...
    CalculatorModel.prototype.getInputNumber = function () {
        return this.input;
    };
    // other
    CalculatorModel.prototype.getCurrent = function () {
...
;// CONCATENATED MODULE: ./src/domain/immutable-calc.ts
...
var handleOp = function (state, op) {
    return fn(state, function (draft) {
        switch (draft.type) {
            case State.initial:
            case State.evaluated:
            case State.num_entered:
                ...
                draft.type = State.op_entered;
                break;
            case State.op_entered:
                draft.stack.pop();
                if (isTerm(op)) {
                    var n = stackTop(draft.stack).n;
                    draft.current = n;
                }
                else {
                    draft.current = evalStack(draft.stack);
    ...
    return fn(state, function (draft) {
        switch (draft.type) {
            ...
            case State.evaluated:
                ...
                break;
            case State.num_entered: {
                var top_1 = stackTop(draft.stack);
                if (top_1) {
                    draft.thunk = { op: top_1.op, r: draft.current };
                }
                draft.stack.push({ type: "num", n: draft.current });
                draft.current = evalStack(draft.stack);
                break;
            ...
            case State.op_entered:
                draft.thunk = {
                    op: stackTop(draft.stack).op,
                    r: stack2nd(draft.stack).n,
                };
                draft.stack.push({ type: "num", n: draft.current });
                draft.current = evalStack(draft.stack);
                break;
        ...
        draft.input = false;
        draft.stack = [];
        draft.type = State.evaluated;
    });
};
var handleC = function (state) {
    return fn(state, function (draft) {
        switch (draft.type) {
            case State.initial:
                break;
...
var handlePlusMinus = function (state) {
    return fn(state, function (draft) {
        switch (draft.type) {
            case State.initial:
            case State.op_entered:
...
var handleLit = function (state, n) {
    return fn(state, function (draft) {
        switch (draft.type) {
            case State.initial:
            case State.op_entered:
...
var handlePercent = function (state) {
    return fn(state, function (draft) {
        switch (draft.type) {
            case State.initial:
                break;
            case State.evaluated:
                ...
                break;
            case State.op_entered: {
                var op = stackTop(draft.stack).op;
                if (isTerm(op)) {
                    draft.current.positive /= 100;
                }
                else {
                    var n = stack2nd(draft.stack).n;
                    var r = draft.current;
                    r.positive /= 100;
            ...
            case State.num_entered: {
                var top_2 = stackTop(draft.stack);
                if (top_2 && top_2.type === "op" && !isTerm(top_2.op)) {
                    var tmp = draft.stack.pop();
                    var val = evalStack(draft.stack);
...
var handlePoint = function (state) {
    return fn(state, function (draft) {
        switch (draft.type) {
            case State.initial:
            case State.op_entered:
...
var getCurrent = function (state) { return toNum(state.current); };
var getActiveOp = function (state) {
    switch (state.type) {
        case State.op_entered:
            return stackTop(state.stack).op;
        case State.num_entered:
            if (state.cleared) {
                var top_3 = stackTop(state.stack);
                if (top_3)
                    return top_3.op;
            }
    }
};
var isInputNumber = function (state) {
    switch (state.type) {
        case State.initial:
            return false;
        case State.evaluated:
...
;// CONCATENATED MODULE: ./src/components/Calculator.tsx
var Calculator_assign = (undefined && undefined.__assign) || function () {
    Calculator_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return Calculator_assign.apply(this, arguments);
};
...
var Button = function (_a) {
    var type = _a.type, long = _a.long, active = _a.active, label = _a.label, onClick = _a.onClick;
    return ((0,jsx_runtime.jsx)("button", Calculator_assign({ className: clsx_m(type === "top" ? "h-10" : "h-14", long && "col-span-2", active && "bg-gray-700 text-gray-50", "w-auto font-semibold text-lg text-gray-900 border border-gray-300 rounded shadow transition-all hover:opacity-60 active:shadow-inner"), onClick: onClick }, { children: label }), void 0));
};
var Calculator = function () {
    var _a = (0,react.useReducer)(calculatorReducer, initialState), state = _a[0], dispatch = _a[1];
    var activeOp = getActiveOp(state);
    var current = getCurrent(state);
    var inputNumber = isInputNumber(state);
    ...
    var handlePlusMinus = function () {
        dispatch({ type: "op", op: "+/-" });
    };
    var handleEq = function () {
        dispatch({ type: "op", op: "=" });
    };
    var handleNum = function (n) { return function () {
        dispatch({ type: "lit", n: n });
    }; };
    return ((0,jsx_runtime.jsxs)("div", Calculator_assign({ className: "w-80 mx-auto px-7 py-7 border border-gray-300 bg-gray-50 shadow-lg" }, { children: [(0,jsx_runtime.jsx)("button", Calculator_assign({ className: "h-20 mb-8 text-gray-50 text-5xl bg-gray-400 rounded shadow-inner" }, { children: (0,jsx_runtime.jsx)("svg", Calculator_assign({ className: "w-full h-full", width: "265", height: "80", viewBox: "0 0 265 80" }, { children: (0,jsx_runtime.jsx)("text", Calculator_assign({ x: "250", y: "60", textAnchor: "end", fill: "currentColor" }, { children: current.toLocaleString() }), void 0) }), void 0) }), void 0), (0,jsx_runtime.jsxs)("div", Calculator_assign({ className: "grid grid-cols-4 gap-3" }, { children: [inputNumber ? ((0,jsx_runtime.jsx)(Button, { type: "top", label: "C", onClick: handleClear }, void 0)) : ((0,jsx_runtime.jsx)(Button, { type: "top", label: "AC", onClick: handleAllClear }, void 0)), (0,jsx_runtime.jsx)(Button, { type: "top", label: "+/-", onClick: handlePlusMinus }, void 0), (0,jsx_runtime.jsx)(Button, { type: "top", label: "%", onClick: handlePercent }, void 0), (0,jsx_runtime.jsx)(Button, { type: "op", label: "\u00F7", active: activeOp === "/", onClick: handleDiv }, void 0), (0,jsx_runtime.jsx)(Button, { type: "num", label: "7", onClick: handleNum(7) }, void 0), (0,jsx_runtime.jsx)(Button, { type: "num", label: "8", onClick: handleNum(8) }, void 0), (0,jsx_runtime.jsx)(Button, { type: "num", label: "9", onClick: handleNum(9) }, void 0), (0,jsx_runtime.jsx)(Button, { type: "op", label: "\u00D7", active: activeOp === "*", onClick: handleMul }, void 0), (0,jsx_runtime.jsx)(Button, { type: "num", label: "4", onClick: handleNum(4) }, void 0), (0,jsx_runtime.jsx)(Button, { type: "num", label: "5", onClick: handleNum(5) }, void 0), (0,jsx_runtime.jsx)(Button, { type: "num", label: "6", onClick: handleNum(6) }, void 0), (0,jsx_runtime.jsx)(Button, { type: "op", label: "-", active: activeOp === "-", onClick: handleSub }, void 0), (0,jsx_runtime.jsx)(Button, { type: "num", label: "1", onClick: handleNum(1) }, void 0), (0,jsx_runtime.jsx)(Button, { type: "num", label: "2", onClick: handleNum(2) }, void 0), (0,jsx_runtime.jsx)(Button, { type: "num", label: "3", onClick: handleNum(3) }, void 0), (0,jsx_runtime.jsx)(Button, { type: "op", label: "+", active: activeOp === "+", onClick: handleAdd }, void 0), (0,jsx_runtime.jsx)(Button, { type: "num", long: true, label: "0", onClick: handleNum(0) }, void 0), (0,jsx_runtime.jsx)(Button, { type: "num", label: ".", onClick: handlePoint }, void 0), (0,jsx_runtime.jsx)(Button, { type: "op", label: "=", onClick: handleEq }, void 0)] }), void 0)] }), void 0));
};

;// CONCATENATED MODULE: ./src/App.tsx


var App = function () { return (0,jsx_runtime.jsx)(Calculator, {}, void 0); };
